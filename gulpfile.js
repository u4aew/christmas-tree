...
gulp.task('production-js', function () {
    return gulp.src(['src/js/jquery-3.1.1.js', 'src/js/bootstrap.js', 'src/js/jquery.fancybox.js', 'src/js/jquery.popup.js', 'src/js/script.js'])
        .pipe(concat('all.js'))
        .pipe(jsmin())
...
gulp.task('production-css', function () {
    gulp.src(['src/style/css/bootstrap.css', 'src/style/css/normalize-bootstrap.css', 'src/style/css/jquery.fancybox.css', 'src/style/css/popup.css', 'src/style/css/style.css'])
